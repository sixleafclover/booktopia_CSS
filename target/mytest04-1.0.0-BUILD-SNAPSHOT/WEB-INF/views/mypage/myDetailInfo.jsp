...
<!-- 					  <input type="button" value="수정하기" onClick="fn_modify_member_info('member_birth')" />-->					  
				...
				<tr class="dot_line">
					...
					<td>
					    ...
					    - <input type="text" maxlength="4" size="4"  name="tel2" value="${memberInfo.tel2 }">
						- <input type="text" maxlength="4" size="4"  name="tel3" value="${memberInfo.tel3 }">
					</td>
...
<!-- 					  <input type="button" value="수정하기" onClick="fn_modify_member_info('tel')" /> -->
				...
				<tr class="dot_line">
					...
					<td>
					   <select  name="hp1" id="hp1">
					 	...
					 	- <input type="text" name="hp2" size=4 maxlength="4" value="${memberInfo.hp2 }">
						- <input type="text"name="hp3"  size=4 maxlength="4" value="${memberInfo.hp3 }"><br> <br>
					 <c:choose> 
				...
				<tr class="dot_line">
					...
					<td>
						<input type="text" id="zipcode" name="zipcode" size=5 maxlength="5" readonly value="${memberInfo.zipcode }" > <a href="javascript:execDaumPostcode()">우편번호검색</a>
						<br>
					  <p> 
