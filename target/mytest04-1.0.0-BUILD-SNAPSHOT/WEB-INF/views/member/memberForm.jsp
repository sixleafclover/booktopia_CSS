			...
			<tbody>
				...
				<tr class="dot_line">
					...
					<td><select  name="tel1">
					   ...
					   </select> - <input  size="10px" type="text" name="tel2" maxlength="4"> - <input size="10px"  type="text" name="tel3" maxlength="4">
					</td>
				</tr>
				<tr class="dot_line">
					...
					</select> - <input size="10px"  type="text" name="hp2" maxlength="4"> - <input size="10px"  type="text"name="hp3" maxlength="4"><br> <br>
