...
public class GoodsDAOImpl implements GoodsDAO {
	...
	@Override
	public List<GoodsVO> sectionselectGoodsList(String goodsStatus) throws DataAccessException {
		List<GoodsVO> goodsList = (ArrayList) sqlSession.selectList("mapper.goods.sectionselectGoodsList", goodsStatus);
		return goodsList;
	}
